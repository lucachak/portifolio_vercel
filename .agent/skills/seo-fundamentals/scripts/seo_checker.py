...
def check_page(file_path: Path) -> dict:
    ...
    is_fragment = 'th:replace=' in content or 'layout:decorate=' in content or 'th:fragment=' in content
    is_layout = ('Head>' in content or '<head>' in content.lower() or '<head ' in content.lower()) and not is_fragment
